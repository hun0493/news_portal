...
class LastestTopic extends StatelessWidget {
  const LastestTopic({super.key});
      ...
      children: [
        ...
        FutureBuilder(
          ...
          builder: (context, snapshot) {
            ...
            final lastesnews = snapshot.data ?? <NewsData>[];
            if (lastesnews.isEmpty) {
              return Center(child: Text(AppTrans.newsList.noData.tr()));
            }

            return GridView.builder(
              itemCount: lastesnews.length,
              shrinkWrap: true,
